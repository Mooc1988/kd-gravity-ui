<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="albums" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                  style="width: 100%;">
        ...
        <el-col :span="24" class="toolbar">
            <el-pagination layout="prev, pager, next" @current-change="handleCurrentChange"
                           :page-size="30" :total="total" style="float:right;">
            </el-pagination>
        </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      getAlbums() {
        ...
        NProgress.start()
        yss.getAlbumListPage(para).then((res) => {
      ...
      editSubmit: function () {
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            ...
            let {title, id} = this.editForm
            let para = {id, title}
            yss.modifyAlbumById(para).then((res) => {
